    ...
    <nav className="footer">
      <div className="footer__grid-container">
        ...
        <div className="footer__grid-4">
          <a className='github__links__creator' href='https://davidleegriffin.github.io/profile' target="_blank" rel="noreferrer">
            <span className="footer__span__names">
        ...
        <div className="footer__grid-5">
          <a className='github__links' href='https://github.com/davidleegriffin/react-stepzen-comets' target="_blank" rel="noreferrer">
